...
const copy = {
  en: {
    ...
    discount: "Discount",
    nights: "nights",
    cleaning: "Final cleaning (incl. 20% VAT)",
    total: "Estimated total",
    deposit: "Refundable deposit",
    disclaimer: "Accommodation rates include 10% VAT. Final cleaning includes 20% VAT. The quote is recalculated and stored by the booking server when you submit.",
    estimate: "Estimated price only. Live availability is temporarily unavailable.",
    festivalRate: "July / August Festival rate (incl. 10% VAT)",
    standardRate: "Standard rate (incl. 10% VAT)",
  ...
  de: {
    ...
    discount: "Rabatt",
    nights: "Nächte",
    cleaning: "Endreinigung (inkl. 20 % USt.)",
    total: "Voraussichtlicher Gesamtpreis",
    deposit: "Rückzahlbare Kaution",
    disclaimer: "Die Unterkunftspreise enthalten 10 % USt. Die Endreinigung enthält 20 % USt. Das Angebot wird beim Absenden vom Buchungsserver neu berechnet und gespeichert.",
    estimate: "Nur geschätzter Preis. Die Live-Verfügbarkeit ist vorübergehend nicht erreichbar.",
    festivalRate: "Festspielpreis Juli / August (inkl. 10 % USt.)",
    standardRate: "Standardpreis (inkl. 10 % USt.)",
